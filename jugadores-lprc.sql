-- ============================================================
-- PLANTEL LPRC — Jugadores con divisiones y posiciones reales
-- Temporada 2026 — Ejecutar en Supabase SQL Editor
-- ============================================================
...
INSERT INTO players (real_team_id, first_name, last_name, position, status, active) VALUES
  ...
  (1, 'Segundo', 'Pineda', 'ALA_IZQ', 'active', true), -- Primera
  ...
  (5, 'Bautista', 'Castagnet', 'ALA_DER', 'active', true), -- Pre C
  (5, 'Francisco', 'Castagnet', 'CENTRO_DER', 'active', true), -- Pre C
  (5, 'Agustin', 'Cufré', 'ALA_DER', 'active', true), -- Pre C
  (5, 'Salvador', 'Curuchaga', 'ALA_DER', 'active', true), -- Pre C
  ...
  (5, 'Tomassoni Francisco', 'Rodriguez', 'ALA_IZQ', 'active', true), -- Pre C
  ...
  (5, 'Franco', 'Del Tufo', 'MEDIO_SCRUM', 'active', true), -- Pre C
  ...
  (6, 'José', 'Bernasconi', 'APERTURA', 'active', true), -- M22
  ...
  (6, 'Gaspar', 'Almerares', 'CENTRO_IZQ', 'active', true), -- M22
  (6, 'Hoggan Ramiro', 'Alvarez', 'PILAR_IZQ', 'active', true), -- M22
  (6, 'Francisco', 'Anselmino', 'CENTRO_IZQ', 'active', true), -- M22
  (6, 'Diego', 'Araujo', 'ALA_BACK_IZQ', 'active', true), -- M22
  (6, 'Mateo', 'Armisen', 'PILAR_IZQ', 'active', true), -- M22
  (6, 'Tomás', 'Barboza', 'SEGUNDO_LINE_IZQ', 'active', true), -- M22
  (6, 'Valentino', 'Barreiro', 'SEGUNDO_LINE_IZQ', 'active', true), -- M22
  (6, 'Tomás', 'Bertoia', 'ALA_IZQ', 'active', true), -- M22
  (6, 'Felipe', 'Biancuzzo', 'APERTURA', 'active', true), -- M22
  (6, 'Tobías', 'Blanco', 'CENTRO_IZQ', 'active', true), -- M22
  (6, 'Ramiro', 'Boffi', 'ALA_BACK_DER', 'active', true), -- M22
  (6, 'Tobías', 'Bragagnolo', 'HOOKER', 'active', true), -- M22
  (6, 'Juan Ignacio', 'Brecevich', 'PILAR_IZQ', 'active', true), -- M22
  (6, 'Pedro', 'Brizzi', 'CENTRO_IZQ', 'active', true), -- M22
  (6, 'Nestor', 'Callegari', 'SEGUNDO_LINE_DER', 'active', true), -- M22
  (6, 'Lucio', 'Calonje', 'ALA_BACK_IZQ', 'active', true), -- M22
  (6, 'Pedro', 'Carabelli', 'HOOKER', 'active', true), -- M22
  (6, 'Thomas', 'Carabelli', 'HOOKER', 'active', true), -- M22
  ...
  (6, 'Jeronimo', 'Coronel', 'PILAR_IZQ', 'active', true), -- M22
  (6, 'Manuel', 'Coste', 'ALA_IZQ', 'active', true), -- M22
  (6, 'Juan Ignacio', 'Crispo', 'CENTRO_IZQ', 'active', true), -- M22
  (6, 'Agustin', 'Cuneo', 'ALA_IZQ', 'active', true), -- M22
  (6, 'Baraibar Iñaki', 'Cunha', 'CENTRO_DER', 'active', true), -- M22
  (6, 'Francisco', 'Dagostino', 'MEDIO_SCRUM', 'active', true), -- M22
  (6, 'Bautista', 'Disanti', 'ALA_IZQ', 'active', true), -- M22
  (6, 'Theo', 'Echegoyen', 'PILAR_IZQ', 'active', true), -- M22
  (6, 'Manuel', 'Etcheverry', 'APERTURA', 'active', true), -- M22
  (6, 'Cortés Juan Cruz', 'Fernandez', 'PILAR_IZQ', 'active', true), -- M22
  (6, 'Matias', 'Ferrario', 'MEDIO_SCRUM', 'active', true), -- M22
  (6, 'Augusto', 'Festa', 'OCTAVO', 'active', true), -- M22
  (6, 'Felipe', 'Franchino', 'ALA_IZQ', 'active', true), -- M22
  (6, 'Lucio', 'Galan', 'CENTRO_DER', 'active', true), -- M22
  (6, 'Jeronimo', 'Gallero', 'ALA_BACK_IZQ', 'active', true), -- M22
  (6, 'Mateo', 'Garat', 'CENTRO_IZQ', 'active', true), -- M22
  (6, 'Manuel', 'Garganta', 'ALA_BACK_IZQ', 'active', true), -- M22
  (6, 'Franco', 'Giambruni', 'APERTURA', 'active', true), -- M22
  (6, 'Salvador', 'Giuliano', 'ALA_IZQ', 'active', true), -- M22
  (6, 'Carrera Agustín', 'Gomez', 'PILAR_IZQ', 'active', true), -- M22
  (6, 'Thiago', 'Gonzalez', 'ALA_IZQ', 'active', true), -- M22
  (6, 'Matías', 'Goñi', 'APERTURA', 'active', true), -- M22
  (6, 'Diogenes', 'Gutierrez', 'ALA_BACK_IZQ', 'active', true), -- M22
  (6, 'Ciro', 'Handula', 'HOOKER', 'active', true), -- M22
  (6, 'Joaquin', 'Jaureguiberry', 'ALA_IZQ', 'active', true), -- M22
  (6, 'Thomas', 'Klat', 'CENTRO_IZQ', 'active', true), -- M22
  (6, 'Valentin', 'Lerga', 'SEGUNDO_LINE_IZQ', 'active', true), -- M22
  (6, 'Franco', 'Lizama', 'PILAR_IZQ', 'active', true), -- M22
  (6, 'Dimarco Lucas', 'Lopez', 'MEDIO_SCRUM', 'active', true), -- M22
  (6, 'Simpson Mariano', 'Lopez', 'CENTRO_DER', 'active', true), -- M22
  (6, 'Tiago', 'Maiocchi', 'SEGUNDO_LINE_IZQ', 'active', true), -- M22
  (6, 'Bautista', 'Maitini', 'ALA_IZQ', 'active', true), -- M22
  (6, 'Francisco', 'Manuele', 'CENTRO_DER', 'active', true), -- M22
  (6, 'Santino', 'Marchetto', 'APERTURA', 'active', true), -- M22
  (6, 'Felipe', 'Mayocchi', 'APERTURA', 'active', true), -- M22
  (6, 'Abel', 'Medina', 'PILAR_IZQ', 'active', true), -- M22
  (6, 'Vilaró Valentín', 'Mietta', 'HOOKER', 'active', true), -- M22
  (6, 'Felipe', 'Moreno', 'ALA_DER', 'active', true), -- M22
  (6, 'Pedro', 'Morgante', 'MEDIO_SCRUM', 'active', true), -- M22
  (6, 'Luciano', 'Muñoz', 'PILAR_IZQ', 'active', true), -- M22
  (6, 'Julián', 'Narizzano', 'CENTRO_IZQ', 'active', true), -- M22
  (6, 'Gomez Felipe', 'Niño', 'CENTRO_IZQ', 'active', true), -- M22
  (6, 'Fausto', 'Odo', 'PILAR_IZQ', 'active', true), -- M22
  (6, 'Valentin', 'Ojer', 'ALA_IZQ', 'active', true), -- M22
  (6, 'Ignacio', 'Orlinsky', 'SEGUNDO_LINE_IZQ', 'active', true), -- M22
  (6, 'Fabrizio', 'Pastorino', 'PILAR_IZQ', 'active', true), -- M22
  (6, 'Corsi Juan Ignacio', 'Perez', 'ALA_IZQ', 'active', true), -- M22
  (6, 'Mateo', 'Permuy', 'ALA_BACK_IZQ', 'active', true), -- M22
  (6, 'Theo', 'Peña', 'ALA_BACK_IZQ', 'active', true), -- M22
  (6, 'Mateo', 'Pianelli', 'ALA_BACK_IZQ', 'active', true), -- M22
  (6, 'Mateo', 'Ricci', 'FULLBACK', 'active', true), -- M22
  (6, 'Justo', 'Ricciardi', 'ALA_BACK_IZQ', 'active', true), -- M22
  (6, 'Maximo', 'Ricciardi', 'ALA_IZQ', 'active', true), -- M22
  (6, 'Segundo', 'Ricciardi', 'ALA_BACK_IZQ', 'active', true), -- M22
  (6, 'Salvador', 'Rinaldi', 'MEDIO_SCRUM', 'active', true), -- M22
  (6, 'Federico', 'Rossi', 'ALA_IZQ', 'active', true), -- M22
  (6, 'Ignacio', 'Sarasqueta', 'CENTRO_DER', 'active', true), -- M22
  (6, 'Salvador', 'Sebastia', 'ALA_IZQ', 'active', true), -- M22
  (6, 'Santiago', 'Seitz', 'SEGUNDO_LINE_IZQ', 'active', true), -- M22
  (6, 'Santiago', 'Sierra', 'ALA_IZQ', 'active', true), -- M22
  (6, 'Tomás', 'Svich', 'ALA_IZQ', 'active', true), -- M22
  (6, 'Bautista', 'Tartaglia', 'SEGUNDO_LINE_IZQ', 'active', true), -- M22
  (6, 'Dante', 'Tucheri', 'PILAR_IZQ', 'active', true), -- M22
  (6, 'Simón', 'Turiansky', 'SEGUNDO_LINE_IZQ', 'active', true), -- M22
...
-- Verificación:
-- SELECT rt.name, COUNT(*) FROM players p JOIN real_teams rt ON rt.id = p.real_team_id WHERE p.active = true GROUP BY rt.name ORDER BY rt.name;